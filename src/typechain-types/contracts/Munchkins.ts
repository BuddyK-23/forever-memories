...
export interface MunchkinsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "balanceOf"
...
export interface Munchkins extends BaseContract {
  connect(runner?: ContractRunner | null): Munchkins;
  waitForDeployment(): Promise<this>;

  interface: MunchkinsInterface;
